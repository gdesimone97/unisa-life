...
public interface Saveable {
     ...
     * @return seriarizable object containig the objects that sub-classes want to save
     */
    public Serializable save();
    /**
     * This method have to be implemented by sub-classes.
     * @param obj containing the object that sub-class has saved and they want load it
